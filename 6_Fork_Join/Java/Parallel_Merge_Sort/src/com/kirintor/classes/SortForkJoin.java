...
import java.util.concurrent.RecursiveAction;
	...
	public class SortForkJoin extends RecursiveAction {
		...
		public final int FINAL_LEN = Main.H;

		
		
		
		public SortForkJoin(Vector vector, int startIndex, int finishIndex) {
			this.finishIndex = finishIndex;
			this.startIndex = startIndex;
			this.vector = vector;
		}
		
		public SortForkJoin(int startIndex, int finishIndex, Vector inputedVector) {
			this.finishIndex = finishIndex;
			this.startIndex = startIndex;
		...
		protected void compute() {
			...
			if (len == FINAL_LEN) {
				vector = new Vector(inputedVector,startIndex,finishIndex);
				vector.sort();
